...
/*******************************************************************************
 * In this exercise we are going to learn how to implement operator overloading
 * on our own classes.
 *
 ...
 *
 * We know that the String class has on overloaded method called plus that
 * allows us to concatenate 2 strings right? So how could we take that logic
 * and make it so we can make the following lines work.
 *
